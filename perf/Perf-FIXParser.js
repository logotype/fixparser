...
console.log('FIX rate (fixed) : ' + rate.toFixed() + ' messages/sec, ' + ((1/rate)*1000).toFixed(3) + 'ms per message.');
...
dateDiff = new Date() - startDate;
rate = (length / dateDiff) * 1000;
console.log('FIX rate (random): ' + rate.toFixed() + ' messages/sec, ' + ((1/rate)*1000).toFixed(3) + 'ms per message.');
